...
import { EntityContentLayoutBlueprint, EntityContentLayoutProps } from '@backstage/plugin-catalog-react/alpha';
import { EntityInfraWalletCard } from '@electrolux-oss/plugin-infrawallet';
...
export const entityOverviewLayoutExtension: ExtensionDefinition = EntityContentLayoutBlueprint.make({
  name: 'overview',
  params: {
